...
```bash
git clone https://github.com/melodic-n/Automated-Application-Security-Pipeline.git
cd https://github.com/melodic-n/Automated-Application-Security-Pipeline.git
```
